...
def on_message(ws, message):
    ...
    point = Point("btc_tick").tag("code", data["code"]).tag("type", data["type"]).tag("ask_bid", data["ask_bid"]).tag("market_warning", data["market_warning"]).tag("stream_type", data["stream_type"]).time(data["timestamp"], WritePrecision.MS)

...
def on_message(ws, message):
    ...
    point = Point("eth_order").tag("code", data["code"]).tag("type", data["type"]).tag("stream_type", data["stream_type"]).time(data["timestamp"], WritePrecision.MS)
